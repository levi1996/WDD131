...
const hikes = [
  ...
  console.log("Case-sensitive sort:", simpleSort);
  ...
  console.log("Search 'an':", searchList(simpleList, "an"));
  ...
  function searchHikes(list, query) {
    ...
    // Sorting by distance (converting to numbers)
  ...
  console.log("Search 'yellowstone':", searchHikes(hikes, "yellowstone"));
  console.log("Search 'moderate':", searchHikes(hikes, "moderate"));
  console.log("Search 'al':", searchHikes(hikes, "al"));
